...
STAGES = [
    ...
    ("stage1",            "training/stage1_gnn_train.py",  []),  # Single-model training (combined)
    # ("stage1_step",       "training/stage1_step_train.py",   []),  # Separate step-optimized model
    # ("stage1_mcp",        "training/stage1_mcp_train.py",    []),  # Separate MCP-optimized model
